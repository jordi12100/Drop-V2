...
var languageForText = function(text) {
    var highlightObject = hljs.highlightAuto(text);

    if (!highlightObject || !highlightObject.language) {
        return 'text';
    }

    if (highlightObject.language === 'php' && text.indexOf('<?php') === -1) {
        return highlightObject.second_best.language;
    }

    return highlightObject.language
}